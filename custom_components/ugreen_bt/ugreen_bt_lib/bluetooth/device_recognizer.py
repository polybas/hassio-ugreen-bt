...
from custom_components.ugreen_bt.ugreen_bt_lib.utils.commands import (
...
async def recognize_device(
    ...
    ugreen_device = ProtocolV2Device("Unknown", "Unknown", "Unknown")

    # Create device builder
    device_reader = DeviceReader(bleak_client, ugreen_device, future_builder_method)
