...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up Ugreen Powerstation from a config entry."""

    _LOGGER.debug("Init Ugreen BT Integration")
    ...
    if not bluetooth.async_address_present(hass, address):
        raise ConfigEntryNotReady("Ugreen device not present")
