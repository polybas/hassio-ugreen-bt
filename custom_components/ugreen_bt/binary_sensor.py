...
from .ugreen_bt_lib.field_attributes import FIELD_ATTRIBUTES, FieldType
...
class UgreenBinarySensor(CoordinatorEntity, BinarySensorEntity):
    """Ugreen universal binary sensor."""
