...
from custom_components.ugreen_bt.ugreen_bt_lib.utils.commands import ReadHoldingRegisters
from custom_components.ugreen_bt.ugreen_bt_lib.utils.struct import DeviceStruct
